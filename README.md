...
1. 国家知识产权局专利审查查询系统：<https://cpquery.cponline.cnipa.gov.cn>，国家知识产权局的官方网站，中国专利的审查信息都从这个网站上查，用户体验极差，但是不用不行。
...
1. 台湾专利资讯检索系统：<https://tiponet.tipo.gov.tw>，我才不会把它叫做中华民国专利资讯检索系统。
1. 澳门特别行政区经济局：<https://www.economia.gov.mo>，虽然不是知识产权局，但这也过分了，瞧这域名，究竟有没有回归啊？
1. incoPat：<http://www.incopat.com>，来自合享汇智，中国高端专利信息数据库，较为好用，收录有 117 个国家的专利，这大概是全球最全的专利数据库了，费用较高，而且也没有免费版本，感兴趣的可以申请试用，给试用期很大方的；加工好的字段极为丰富，是目前字段最为丰富的专利数据库，没有之一；缺点是检索结果页面大片空白浪费屏幕；专利查看页面的单页视图和双页视图的割裂感较强，影响用户体验，单页版不方便对照着看文字和附图，双页版又无法查看同族专利、引证专利和相似专利，反馈多次也不见改善这一问题。incoPat也有了智能检索，很类似于智慧芽的AI agent，不过与智慧芽的AI agent采取了不同的策略，它可以根据一段文本生成多个检索块（检索片断）供用户调用，用户根据已有的检索块来构建最终的检索式。
1. Patentics：<http://www.patentics.com>，语义搜索技术发挥到了一定水平，也许是中国最个性最超前的系统，缺点是语法较难，像是给程序员准备的而不是给普通用户准备的，免费版只能查看第一检索结果的第一页，且功能受限。
1. 智慧芽：<https://www.zhihuiya.com>，新加坡的公司，苏州和英国也有公司，收费数据库，且费用较高，给的试用期通常也较短，感兴趣的可以申请试用。随着AI的发展，智慧芽推出了AI agent功能，它能够根据用户输入的文本自动生成检索式并进行检索，还能够根据检索结果修改检索式，比较智能，非常适合没有检索经验的发明人，也适合经验丰富的专利检索分析师、IPR初步构建检索式。
...
1. 中国知网：<https://kns.cnki.net/kns8s/?classid=VUDIXAIY>，专利数据无处不在。
1. 万方数据：<https://c.wanfangdata.com.cn/patent>，多乎哉，不多已。
...
1. 中国专利网：<http://www.cnpatent.com>，中国专利技术开发公司开发。
...
1. 谷歌专利：<http://www.google.com/patents>，上手非常容易，查询专利速度很快，也有表格检索<https://patents.google.com/advanced>，也可以构建表达式，支持检索化学式，高级用法参见帮助页面<https://support.google.com/faqs/answer/7049475>。
...
1. 国家知识产权局 IPC 分类查询：<http://epub.cnipa.gov.cn/ipc>，此外国家知识产权局还会在这个页面 <https://www.cnipa.gov.cn/col/col3161/index.html> 定期更新 IPC 分类号文档，可以将自己最常使用的部分提取并打印出来放置在桌面上，日常不建议用其作分类号检索。
